import AssuranceCreditMultiStepForm from '@/components/AssuranceCreditMultiStepForm';
import PressLogos from '@/components/PressLogos';
import { Icons } from '@/components/Icons';

export default function AssuranceCreditPage() {
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-7">
              ...
              <h1 className="mt-4 font-archivo-black text-3xl md:text-5xl text-gray-900 leading-tight">
                Protégez-vous des impayés et sécurisez votre trésorerie
              </h1>
              <p className="mt-4 text-lg md:text-xl text-gray-700 max-w-2xl">
                Défaillance client, retard de paiement, risque politique à l'export... L'assurance-crédit sécurise vos transactions en France comme à l'international.
              </p>
              
              <ul className="mt-6 grid sm:grid-cols-2 gap-3 text-sm text-gray-700">
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Impayés couverts</strong>{' '}jusqu'à 90%</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Export sécurisé</strong>{' '}(risque politique inclus)</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Recouvrement</strong>{' '}pris en charge</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Information clients</strong>{' '}en temps réel</li>
              </ul>
            ...
            <div className="md:col-span-5">
              <div className="bg-white/80 backdrop-blur border rounded-2xl shadow-xl p-6 md:p-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-3xl font-bold text-[#1E3A8A]">350+</div>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Pourquoi l'assurance-crédit est devenue essentielle</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Les défaillances d'entreprises ont augmenté de <strong>+35% en 2 ans</strong>. Un seul impayé important peut mettre en péril votre trésorerie.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl border-l-4 border-red-500">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Défaillances en hausse</h3>
              <p className="text-gray-700">Faillites, procédures collectives, liquidations... Un client défaillant peut entraîner des impayés massifs.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border-l-4 border-orange-500">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Impact trésorerie</h3>
              <p className="text-gray-700">Un impayé de 50 K€ peut bloquer vos paiements fournisseurs et salaires. L'effet domino est rapide.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500">
              <div className="text-yellow-600 mb-3"><Icons.ShieldCheck className="w-10 h-10" /></div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Export à risque</h3>
              <p className="text-gray-700">Risque politique, change, réglementation... L'export multiplie les risques d'impayés sans protection adaptée.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 id="garanties" className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Les garanties courantes en Assurance-crédit</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { Icon: Icons.Shield, color: 'text-blue-600', t: 'Couverture impayés', d: 'Indemnisation de 80-90% des créances impayées suite à défaillance avérée du client (procédure collective, faillite).' },
              { Icon: Icons.Target, color: 'text-green-600', t: 'Risque politique export', d: 'Protection contre guerre, embargo, non-transfert de devises, annulation de licence dans les pays à risque.' },
              { Icon: Icons.Database, color: 'text-purple-600', t: 'Information clients', d: 'Accès bases de données solvabilité, scoring en temps réel, alertes défaillance pour anticiper.' },
              { Icon: Icons.Cog, color: 'text-indigo-600', t: 'Recouvrement amiable', d: 'Prise en charge des démarches de recouvrement avant passage contentieux (relances, négociation).' },
              { Icon: Icons.Scale, color: 'text-cyan-600', t: 'Contentieux & juridique', d: 'Accompagnement procédures de recouvrement contentieux, frais de justice, représentation.' },
              { Icon: Icons.ChartBar, color: 'text-red-600', t: 'Gestion du poste clients', d: 'Outils de pilotage, reporting, aide à la décision crédit, optimisation DSO (délai de paiement).' },
            ].map((card) => (
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">En 3 étapes, identifiez vos besoins et soyez mis en relation avec des spécialistes assurance-crédit.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { n: '01', t: 'Remplissez le questionnaire', d: 'Informations sur votre activité commerciale, vos clients et votre exposition. 3 minutes chrono.' },
              { n: '02', t: 'On vous met en relation', d: 'Nous transmettons votre profil à des courtiers spécialisés assurance-crédit. Contact sous 24h.' },
              { n: '03', t: 'Vous échangez avec un expert', d: 'Un courtier certifié ORIAS analyse vos flux et compare les solutions du marché (Euler Hermes, Coface, Atradius...).' },
            ].map(step => (
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { quote: "Un client a fait faillite avec 80 K€ de factures impayées. Heureusement, on avait souscrit l'assurance-crédit via le courtier recommandé. Indemnisation à 85%.", author: "Pierre L.", title: "DAF", company: "PME industrielle export" },
              { quote: "Le questionnaire nous a aidés à quantifier notre exposition. Le courtier a trouvé une couverture adaptée à notre activité export avec risque politique inclus.", author: "Nathalie D.", title: "Directrice", company: "Négoce international" },
              { quote: "Service gratuit et pro. Mise en relation rapide avec un courtier spécialiste crédit. Il a comparé Euler Hermes, Coface et Atradius. Souscription en 72h.", author: "Stéphane M.", title: "Gérant", company: "Grossiste alimentaire" },
            ].map((t, i) => (
      ...
      <section id="questionnaire" className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Prêt à sécuriser votre trésorerie ?</h2>
            <p className="text-gray-600 mt-2">Plus de 350 entreprises ont déjà franchi le pas. Complétez votre questionnaire en 3 minutes et soyez contacté sous 24h.</p>
