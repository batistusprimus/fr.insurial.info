import FlotteAutoMultiStepForm from '@/components/FlotteAutoMultiStepForm';
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-7">
              ...
              <h1 className="mt-4 font-archivo-black text-3xl md:text-5xl text-gray-900 leading-tight">
                Protégez votre parc automobile et maîtrisez vos coûts
              </h1>
              <p className="mt-4 text-lg md:text-xl text-gray-700 max-w-2xl">
                Accident, vol, bris de glace, assistance... Vos véhicules pro méritent une couverture adaptée. Découvrez les offres flotte qui optimisent votre budget.
              </p>
              
              <ul className="mt-6 grid sm:grid-cols-2 gap-3 text-sm text-gray-700">
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Gestion centralisée</strong> du parc</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Assistance 24/7</strong> incluse</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Tarifs négociés</strong> flotte</li>
                <li className="flex items-center"><span className="mr-2 text-blue-700 text-lg">✓</span> <strong>Véhicules de remplacement</strong> disponibles</li>
              </ul>
            ...
            <div className="md:col-span-5">
              <div className="bg-white/80 backdrop-blur border rounded-2xl shadow-xl p-6 md:p-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-3xl font-bold text-[#1E3A8A]">450+</div>
                  <div className="text-xs text-gray-600 text-right">Flottes<br />déjà assurées</div>
                </div>
                <div className="flex items-center justify-between mb-4">
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Pourquoi une assurance flotte change tout</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Gérer plusieurs véhicules avec des contrats individuels coûte <strong>plus cher et prend plus de temps</strong>. Une flotte simplifie tout.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl border-l-4 border-red-500">
              <div className="text-red-600 mb-3"><Icons.Car className="w-10 h-10" /></div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Risques quotidiens</h3>
              <p className="text-gray-700">Accidents responsables, vol, bris de glace répétés... Les véhicules pros sont très exposés.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border-l-4 border-orange-500">
              ...
              <p className="text-gray-700">Une assurance flotte négocie des tarifs groupés. Économie typique: 15-25% vs contrats individuels.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500">
              <div className="text-yellow-600 mb-3"><Icons.Clock className="w-10 h-10" /></div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestion simplifiée</h3>
              <p className="text-gray-700">Un seul interlocuteur, une seule échéance, une seule attestation. Gain de temps administratif énorme.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 id="garanties" className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Les garanties courantes en Flotte Auto</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { Icon: Icons.Shield, color: 'text-blue-600', t: 'Responsabilité Civile', d: 'Dommages causés à des tiers (obligatoire). Couverture des dommages corporels et matériels.' },
              { Icon: Icons.Target, color: 'text-purple-600', t: 'Tous risques / Tiers+', d: 'Dommages tous accidents (collision, sortie de route) même responsable, avec ou sans franchise.' },
              { Icon: Icons.Alert, color: 'text-red-600', t: 'Vol & incendie', d: 'Remboursement du véhicule volé ou détruit par incendie, selon valeur à dire d\'expert ou valeur déclarée.' },
              { Icon: Icons.Eye, color: 'text-cyan-600', t: 'Bris de glace', d: 'Remplacement pare-brise, vitres latérales, lunette arrière sans franchise ou franchise réduite.' },
              { Icon: Icons.Support, color: 'text-green-600', t: 'Assistance & dépannage', d: 'Remorquage, véhicule de remplacement, rapatriement en cas de panne ou accident.' },
              { Icon: Icons.UserGroup, color: 'text-indigo-600', t: 'Conducteur', d: 'Protection du conducteur en cas de blessures (indemnités, capital invalidité/décès).' },
            ].map((card) => (
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">En 3 étapes, identifiez vos besoins et soyez mis en relation avec des spécialistes flotte automobile.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { n: '01', t: 'Remplissez le questionnaire', d: 'Informations sur votre parc, types de véhicules, conducteurs et usage. 3 minutes chrono.' },
              { n: '02', t: 'On vous met en relation', d: 'Nous transmettons votre profil à des courtiers spécialisés flottes. Contact sous 24h.' },
              { n: '03', t: 'Vous échangez avec un expert', d: 'Un courtier certifié ORIAS compare les offres du marché et négocie les meilleurs tarifs pour votre parc.' },
            ].map(step => (
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { quote: "15 utilitaires à assurer. Le courtier contacté via Insurial a comparé 4 offres et négocié une réduction de 20%. Gain annuel: 3 000 €.", author: "Vincent R.", title: "Gérant", company: "Livraison express" },
              { quote: "Le questionnaire nous a aidés à clarifier nos besoins (tous risques ou tiers+). Le courtier a trouvé le bon équilibre garanties/prix.", author: "Émilie T.", title: "DAF", company: "Société de services" },
              { quote: "Service gratuit et professionnel. Mise en relation rapide avec un courtier spécialiste flottes. Contrat signé en 72h, véhicules de remplacement inclus.", author: "Alexandre P.", title: "Directeur", company: "Transport routier" },
            ].map((t, i) => (
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { q: 'Combien de véhicules minimum ?', a: 'Généralement dès 3-5 véhicules selon l\'assureur. En dessous, des contrats individuels peuvent être plus adaptés.' },
              { q: 'Conducteurs nommés ou tous conducteurs ?', a: 'Au choix. Conducteurs nommés: tarif réduit mais moins de flexibilité. Tous conducteurs: plus cher mais pratique.' },
              { q: 'Peut-on mixer VP, VUL, PL ?', a: 'Oui. Les assureurs flotte acceptent généralement un mix de types de véhicules avec tarification adaptée.' },
              { q: 'Combien de temps ça prend ?', a: '3 minutes pour le questionnaire. Un courtier spécialisé flottes vous contacte sous 24-48h pour comparer les offres.' },
      ...
      <section id="questionnaire" className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Prêt à optimiser votre flotte ?</h2>
            <p className="text-gray-600 mt-2">Plus de 450 flottes ont déjà franchi le pas. Complétez votre questionnaire en 3 minutes et soyez contacté sous 24h.</p>
