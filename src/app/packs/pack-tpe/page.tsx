import PackTPEMultiStepForm from '@/components/PackTPEMultiStepForm';
  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            <div className="md:col-span-5">
              <div className="bg-white/80 backdrop-blur border rounded-2xl shadow-xl p-6 md:p-8">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-3xl font-bold text-[#1E3A8A]">900+</div>
                  <div className="text-xs text-gray-600 text-right">TPE<br />déjà mises en relation</div>
                </div>
                <div className="flex items-center justify-between mb-4">
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Pourquoi un pack complet TPE change tout</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Gérer 3-4 contrats séparés coûte <strong>plus cher en temps et en argent</strong>. Un pack unifié simplifie votre gestion et optimise vos garanties.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-orange-500">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Économies globales</h3>
              <p className="text-gray-700">Tarif négocié groupé. Économie typique: 10-20% vs souscriptions individuelles dispersées.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-500">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestion ultra-simple</h3>
              <p className="text-gray-700">Un seul interlocuteur, une seule échéance annuelle, un seul document. Gain de temps administratif majeur.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">En 3 étapes, identifiez vos besoins et soyez mis en relation avec des courtiers spécialisés TPE.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { n: '01', t: 'Remplissez le questionnaire', d: 'Informations sur votre activité, vos besoins de couverture et votre situation. 3 minutes chrono.' },
              { n: '02', t: 'On vous met en relation', d: 'Nous transmettons votre profil à des courtiers spécialisés packs TPE. Contact sous 24h.' },
              { n: '03', t: 'Vous échangez avec un expert', d: 'Un courtier certifié ORIAS compose un pack sur mesure et compare les offres du marché pour vous.' },
            ].map(step => (
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Ce que disent les TPE</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
      ...
      <section id="questionnaire" className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Prêt à simplifier votre gestion assurance ?</h2>
            <p className="text-gray-600 mt-2">Plus de 900 TPE ont déjà franchi le pas. Complétez votre questionnaire en 3 minutes et soyez contacté sous 24h.</p>
